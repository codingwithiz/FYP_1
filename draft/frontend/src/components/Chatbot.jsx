...
function Chatbot({ onExtracted, onClose, onShowRecommendations }) {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ fontWeight: "bold" }}>Business Location Chatbot</span>
        <button
          onClick={onClose}
          style={{
      ...
      <div style={{ display: "flex", flex: 1, minHeight: 0 }}>
        ...
        >
          ...
          <div style={{
            ...
            {sidebarOpen && (
              <h4 style={{ margin: 0, fontSize: 14, flex: 1 }}>Past Chats</h4>
            )}
            <button
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0, flex: 1, overflowY: "auto" }}>
                {chats.map((chat) => (
                  <li
                    key={chat.chatId}
                    style={{
                      background: selectedChat === chat.chatId ? "#e3f2fd" : "transparent",
                      marginBottom: 4,
                      padding: 4,
                      borderRadius: 6,
                      cursor: "pointer",
